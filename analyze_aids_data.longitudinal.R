...
# ---- use kfold for model comparison ----

kfold_k <- 10
long0.kfold <- with_filecache(kfold(long0, K = kfold_k),
                            filename = 'long0.kfold.rds')
long1.kfold <- with_filecache(kfold(long1, K = kfold_k),
                            filename = 'long1.kfold.rds')
long2.kfold <- with_filecache(kfold(long2, K = kfold_k),
                            filename = 'long2.kfold.rds')
long3.kfold <- with_filecache(kfold(long3, K = kfold_k),
                            filename = 'long3.kfold.rds')
long4.kfold <- with_filecache(kfold(long4, K = kfold_k),
                            filename = 'long4.kfold.rds')
long5.kfold <- with_filecache(kfold(long5, K = kfold_k),
                            filename = 'long5.kfold.rds')
long6.kfold <- with_filecache(kfold(long6, K = kfold_k),
                              filename = 'long6.kfold.rds')

kfold_comp <- loo::compare(long0.kfold, long1.kfold, long2.kfold, long3.kfold, long4.kfold, long5.kfold, long6.kfold)
